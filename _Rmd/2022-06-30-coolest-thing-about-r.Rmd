...
I would have to say that one of the coolest things about R is `ggplot2`.  While a bit of a steep learning curve (I self-taught myself a lot in ST502 for the final project), the power and flexibility is pretty amazing.  Something similar to what I created for the last homework is below:
